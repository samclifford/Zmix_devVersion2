...
PostProcUnivariate<-function( Grun,  Y, prep=10000,LineUp=1,Propmin=0.3, isSim=TRUE, simlabel="sim"){
		...
		## 2. unswitch
		GrunK0us<-QuickSwitch_allPars(GrunK0, isSim=isSim, LineUpBy=LineUp,PropMin=Propmin )
